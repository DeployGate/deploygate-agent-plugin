...
- `references/terminology.md` — **Read this first**, before writing any user-facing response. Defines the Japanese terms (ワークスペース / プロジェクト / チーム / 共有チーム) you must use with users.
...
Only after both are confirmed, say: "Phase 1 is complete — your app is being distributed to testers via DeployGate."
